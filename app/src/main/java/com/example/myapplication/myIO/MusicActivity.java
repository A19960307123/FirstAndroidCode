...
public class MusicActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initMediaPlayer() {
        try {
            File file = new File(Environment.getExternalStorageDirectory(), "qqmusic/song/周杰伦-星晴.mp3");
            Log.d("音频播放", "initMediaPlayer: "+Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_MUSIC));
