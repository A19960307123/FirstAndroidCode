...
public class CameraActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d(TAG, " Environment.getExternalStorageDirectory().getPath()=="+path1);
        String path2 = getApplicationContext().getExternalFilesDir(null).getPath();
        Log.d(TAG, " Environment.getExternalStorageDirectory().getPath()=="+path2);
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_camera);
        Button takePthot = findViewById(R.id.take_photo);
        ...
        takePthot.setOnClickListener(v -> {
